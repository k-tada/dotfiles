...
" Python Support
" let g:python_host_prog = expand('$HOME') . '/.anyenv/envs/pyenv/versions/neovim-2/bin/python'
let g:python3_host_prog = expand('$HOME') . '/.anyenv/envs/pyenv/versions/noevim-3/bin/python'
